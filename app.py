...
<div class="subtitle">
To use this application, you just need to upload your documents, preferably with a copy of UNDRIP, select your preferred prompt, which you can update, select the relevant workflow and document type before creating your case.
</div>
""",
    unsafe_allow_html=True,
)
