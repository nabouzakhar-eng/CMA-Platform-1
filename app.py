...
The legal dossier and reports are generated by specialised AI Agents, and can be used by IPs to report any violations. The reports produced are intended to support IPs and minimise the time and costs associated with initiating legal proceedings or lawsuits in the future.

To use this application, you need to upload your documents, preferably with a copy of UNDRIP, select your preferred prompt, which you can update, select the relevant workflow and document type before creating your case.
</div>
""",
    unsafe_allow_html=True,
)
